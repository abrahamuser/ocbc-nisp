...
public class ObCorporateAccountOverview implements Serializable
{
    ...
    private String auto_renewal_desc;
	...
	public String getAuto_renewal_desc() {
		return auto_renewal_desc;
	}
	public void setAuto_renewal_desc(String auto_renewal_desc) {
		this.auto_renewal_desc = auto_renewal_desc;
	}
