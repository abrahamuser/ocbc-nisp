...
public class CRCUtil {
	...
	public static void main(String args[]){
		try{
			...
			// Kermit ASCII
		    System.out.println(Double.valueOf(testStr).intValue());
		    ...
		    // Kermit ASCII
		    System.out.println("CRC-CCITT (Kermit) Ascii: "
		            + getCRC16CCITT(testStr, 0x8408, 0x0000, false));
		 ...
		 // Kermit Hex
		    System.out.println("CRC-CCITT (Kermit) Hex: "
		            + getCRC16CCITT(testStr, 0x8408, 0x0000, true));*/
		}catch(Exception e){
			e.printStackTrace();
		}
	}
