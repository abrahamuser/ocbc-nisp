...
@Service
public class SoftwareTokenPreBind2Request extends FuncServices  
{
	...
	public MICBResponseBean process(MICBRequestBean arg0) {
		...
		try {
			...
			vcTokenRequest.setDevice_code(requestData.getDevice_code());
			...
			VCResponse vcResponse = tokenService.callOmniVC(TokenRequestData.method_software_token_preBind2,vcTokenRequest, vcTokenResponseData, requestData.getUserContext().getSessionId(), arg0.getTranxID(), ipAddress);
			...
			if(vcResponse.getResponse_code().equalsIgnoreCase(MiBConstant.OMNI_SUCCESS))
			{
				...
				obResponse.setDevice_id_velis(vcTokenResponseData.getDevice_id_velis());
				obResponse.setMessage_activation_2(vcTokenResponseData.getMessage_activation_2());
				obResponse.setSequence_number(vcTokenResponseData.getSequence_number());
