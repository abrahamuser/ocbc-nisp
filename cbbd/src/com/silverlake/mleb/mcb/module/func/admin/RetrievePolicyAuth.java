...
@Service
public class RetrievePolicyAuth extends FuncServices  
{

	private static Logger log = LogManager.getLogger(RetrievePolicyAuth.class);
		...
		try {
			...
			VCResponse<AuthResponseData> vcResponse = 
					usrService.callOmniVC(
							AuthRequestData.method_auth_admin_policy_pending,
			...
			if(vcResponse.getResponse_code().equalsIgnoreCase(MiBConstant.OMNI_SUCCESS))
			{
				...
				obResponse.setPolicy_list( policyPendingAuthRp.getAuthpol_list());
