 ...
 * transaction/inquiry/bifast - fast usage
 ...
 */
@Service
public class TransactionFundTransferConfirmSubmit extends CacheSessionFuncServices<ObTransactionRequest, ObTransactionResponse, ObSessionCache>{
	private static Logger log = LogManager.getLogger(TransactionFundTransferConfirmSubmit.class);
