...
@Service
public class PerformLogout extends FuncServices  
{
	...
	public MICBResponseBean process(MICBRequestBean arg0) {
		...
		try {
			...
			VCResponse<ResponseData> vcResponse = usrService.callOmniVC(VCMethodConstant.REST_METHODS.USER_LOGOUT, vcLoginRequest, vcResponseData, requestData.getUserContext().getSessionId(), arg0.getTranxID(), ipAddress);
