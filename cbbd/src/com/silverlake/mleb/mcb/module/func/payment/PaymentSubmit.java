 ...
 */
@Service
public class PaymentSubmit extends CacheSessionFuncServices<ObPaymentRequest, ObPaymentResponse, ObPaymentSessionCache>{
	private static Logger log = LogManager.getLogger(PaymentSubmit.class);
