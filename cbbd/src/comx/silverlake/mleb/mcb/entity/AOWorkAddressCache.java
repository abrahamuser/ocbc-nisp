...
//@Entity
@Table(name = "AO_WORK_ADDRESS_CACHE")
public class AOWorkAddressCache implements java.io.Serializable{
	...
	@SequenceGenerator(name = "id_Sequence", sequenceName = "AO_WORK_ADDRESS_CACHE_id")
