...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'LLG','Pembayaran LLG/SKN','TRANXPRODCODE_IN','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'RTGS','Pembayaran RTGS','TRANXPRODCODE_IN','A');
...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'TDAO','Pembukaan Deposito','TRANXPRODCODE_IN','A');
...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'CSWTH','Penarikan Dana','TRANXPRODCODE_IN','A');
...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'SPIDR','Pembayaran Bulk IDR Supplier','TRANXPRODCODE_IN','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'PYIDR','Pembayaran Bulk IDR Payroll','TRANXPRODCODE_IN','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'SPFCY','Pembayaran Bulk Valuta Asing Supplier','TRANXPRODCODE_IN','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'PYFCY','Pembayaran Bulk Valuta Asing Payroll','TRANXPRODCODE_IN','A');
...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'LLG','LLG/SKN Payment','TRANXPRODCODE','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'RTGS','RTGS Payment','TRANXPRODCODE','A');
...
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'TDAO','Time Deposit Opening','TRANXPRODCODE','A');
INSERT INTO mleb_mcb.generalcode (row_id,gncode,gncode_description,gncode_type,status) VALUES (mleb_mcb.GeneralCode_id.nextval,'TDAM','Time Deposits Rollover Maintenance','TRANXPRODCODE','A');
