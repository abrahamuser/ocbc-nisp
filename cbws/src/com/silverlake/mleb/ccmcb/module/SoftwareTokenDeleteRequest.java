...
public class SoftwareTokenDeleteRequest extends MiBServices
{
	public SoftwareTokenDeleteRequest(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_SOFT_TOKEN_DELETE;
		return obRequest;
	}
	...
	public void processResponse()
	{
		...
		{
			httpSession.setAttribute(WSConstant.MIB_SOFT_TOKEN_DELETE, obResponse);
		}
	}
