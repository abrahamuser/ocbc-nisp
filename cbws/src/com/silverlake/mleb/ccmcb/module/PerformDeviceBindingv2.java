...
public class PerformDeviceBindingv2 extends MiBServices
{

	
	
	public PerformDeviceBindingv2(WebServiceContext session) {
		super(session);
	...
	private static Logger log = LogManager.getLogger(PerformDeviceBindingv2.class);
	ObAuthenticationRequest obRequest;
	private String loginID;
	
	@Override
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_MCB_DVBINDING_V2;
		return obRequest;
	}
