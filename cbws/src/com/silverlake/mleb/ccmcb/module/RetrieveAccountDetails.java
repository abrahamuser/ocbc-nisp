...
public class RetrieveAccountDetails extends MiBServices
{

	public RetrieveAccountDetails(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_ACC_DETAILS;
		return obRequest;
	}

	public void processData(String index)
	{
