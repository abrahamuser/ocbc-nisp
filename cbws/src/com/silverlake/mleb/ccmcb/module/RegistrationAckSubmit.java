...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_REG_ACK_SUBMIT)

public class RegistrationAckSubmit extends CacheSessionMiBServices<ObRegistrationRequest, ObRegistrationResponse, ObRegistrationeUserSessionCache> {
    ...
    public RegistrationAckSubmit(WebServiceContext wsContext) {
        super(wsContext);
    }
