...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_AUTH_ADM_BENE_MTN_AUTH)
@WSCache(
		previousCacheIds = {VCMethodConstant.CACHE_IDS.MIB_HTTP_SESSION_AUTH_ADMIN_BENE_PEND_AUTH_LIST},
		isPrevCacheMandatory = {true},
		clearPreviousCacheIds = {VCMethodConstant.CACHE_IDS.MIB_HTTP_SESSION_AUTH_ADMIN_BENE_PEND_AUTH_LIST},
		isSuccessClearPreviousCache = {true}
)
public class AuthorizationPerformApprovalPendingBeneficiary extends CacheSessionMiBServices<ObAuthorizationRequest, ObAuthorizationResponse, ObAuthorizationSessionCache>{
    ...
    public AuthorizationPerformApprovalPendingBeneficiary(WebServiceContext wsContext) {
        super(wsContext);
    }
