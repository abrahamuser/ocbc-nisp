...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_ADD_DELETE_SIGNER)


public class AddDeleteSignerData extends CacheSessionMiBServices<ObRegistrationRequest, ObRegistrationResponse, ObRegistrationeUserSessionCache> {
    ...
    public AddDeleteSignerData(WebServiceContext wsContext) {
        super(wsContext);
    }
