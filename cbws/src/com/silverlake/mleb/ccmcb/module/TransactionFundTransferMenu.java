...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TRANS_FUND_TRANS_MENU)
@WSCache(
		cacheId=VCMethodConstant.CACHE_IDS.EMPTY,
		clearPreviousCacheIds={},
		isSuccessClearPreviousCache={}
)
public class TransactionFundTransferMenu extends CacheSessionMiBServices<ObTransactionRequest, ObTransactionResponse, ObSessionCache>{
	@WSParameter(isMandatory=true)
	protected List<String> transferServiceTypes;
	
	public TransactionFundTransferMenu(WebServiceContext wsContext) {
		super(wsContext);
	}

	@Override
	public void processData() throws Exception{
		obRequest.setTransferServiceTypes(transferServiceTypes);
	}
