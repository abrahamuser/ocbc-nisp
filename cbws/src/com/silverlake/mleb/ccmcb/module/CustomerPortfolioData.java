...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_CUSTOMER_PORTFOLIO_DATA)

public class CustomerPortfolioData extends CacheSessionMiBServices<ObAccountListRequest, ObAccountListResponse, ObAccountListSessionCache> {
	...
	protected Boolean agreementOnly;

    public CustomerPortfolioData(WebServiceContext wsContext) {
        super(wsContext);
    }
    ...
    protected void processData() throws Exception {
        ...
        obRequest.setAgreementOnly(agreementOnly);
