...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_AUTH_ADM_ACCT_MTN_AUTH)
@WSCache(
		previousCacheIds = {VCMethodConstant.CACHE_IDS.MIB_HTTP_SESSION_AUTH_ADMIN_ACCT_PEND_AUTH_LIST},
		isPrevCacheMandatory = {true},
		clearPreviousCacheIds = {VCMethodConstant.CACHE_IDS.MIB_HTTP_SESSION_AUTH_ADMIN_ACCT_PEND_AUTH_LIST},
		isSuccessClearPreviousCache = {true}
)
public class AuthorizationPerformApprovalPendingAccount extends CacheSessionMiBServices<ObAuthorizationRequest, ObAuthorizationResponse, ObAuthorizationSessionCache>{
    ...
    public AuthorizationPerformApprovalPendingAccount(WebServiceContext wsContext) {
        super(wsContext);
    }
