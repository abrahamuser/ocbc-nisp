...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_USER_PROFILE_LIST)
@WSCache(
		cacheId=VCMethodConstant.CACHE_IDS.MIB_HTTP_SESSION_USER_PROFILE_LIST
)

public class AdministrationUserProfileList extends CacheSessionMiBServices<ObAdministrationUserRequest, ObAdministrationUserResponse, ObAdministrationUserSessionCache> {


    public AdministrationUserProfileList(WebServiceContext wsContext) {
        super(wsContext);
    }
