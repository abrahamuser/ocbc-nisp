...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_ONFX_GET_RATE)
@WSCache(
		cacheId=VCMethodConstant.CACHE_IDS.EMPTY,
		clearPreviousCacheIds={},
		isSuccessClearPreviousCache={}
)
public class ONFXGetRate extends CacheSessionMiBServices<ObForexRequest, ObForexResponse, ObForexSessionCache>{
	@WSParameter(isMandatory=false)
	protected String currency;
	
	@WSParameter(isMandatory=false)
	protected Boolean isCrossCurrency;
	
	@WSParameter(isMandatory=false)
	protected String currency2;
	
	public ONFXGetRate(WebServiceContext wsContext) {
		super(wsContext);
	}
	...
	public void processData() throws Exception{
		...
		obRequest.setIsCrossCurrency(isCrossCurrency);
