...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_BENE_CATEGORY)

public class RetrieveBeneficiaryCategory extends SessionMiBServices<ObTransactionRequest, ObTransactionResponse> {
	
	@WSParameter(isMandatory=true)
	protected String purposeCode;
			
    public RetrieveBeneficiaryCategory(WebServiceContext wsContext) {
        super(wsContext);
    }
