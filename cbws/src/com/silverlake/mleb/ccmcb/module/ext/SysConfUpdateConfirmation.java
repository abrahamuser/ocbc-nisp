...
public class SysConfUpdateConfirmation extends MiBServices
{


	public SysConfUpdateConfirmation(WebServiceContext session) {
		super(session);
	...
	private static Logger log = LogManager.getLogger(SysConfUpdateConfirmation.class);
	ObSysConfRequest obRequest;
	
	@Override
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_EXT_SYSUPDATECONFM;
		return obRequest;
	}
