...
public class DeviceCIFUnBind extends MiBServices
{


	public DeviceCIFUnBind(WebServiceContext session) {
		super(session);
	...
	private static Logger log = LogManager.getLogger(DeviceCIFUnBind.class);
	ObDeviceBindingRequest obRequest;
	
	@Override
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_DVUNBIND;
		return obRequest;
	}
