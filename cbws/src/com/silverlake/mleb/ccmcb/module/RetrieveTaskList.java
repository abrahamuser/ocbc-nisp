...
public class RetrieveTaskList extends MiBServices
{

	
	
	public RetrieveTaskList(WebServiceContext session) {
		super(session);
	...
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_MCB_RETRIEVE_TASK_LIST;
		return obRequest;
	}
	
	
	
	public void processData(String trnxSourceList)
	{
		...
		obRequest.setTranxSourcelist(trnxSourceList);
	}
