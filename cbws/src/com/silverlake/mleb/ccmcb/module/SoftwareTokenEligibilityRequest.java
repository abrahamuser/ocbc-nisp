...
public class SoftwareTokenEligibilityRequest extends MiBServices
{
	public SoftwareTokenEligibilityRequest(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_SOFT_TOKEN_ELIGIBILITY;
		return obRequest;
	}
	...
	public void processResponse()
	{
		...
		{
			httpSession.setAttribute(WSConstant.MIB_SOFT_TOKEN_ELIGIBILITY, obResponse);
		}
	}
