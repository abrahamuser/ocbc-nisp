...
public class PerformLoginSession extends MiBServices
{

	

	public PerformLoginSession(WebServiceContext session) {
		super(session);
	...
	private static Logger log = LogManager.getLogger(PerformLoginSession.class);
	ObAuthenticationRequest obRequest;
	private String loginID;
	
	@Override
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_MCB_LOGIN;
		return obRequest;
	}
