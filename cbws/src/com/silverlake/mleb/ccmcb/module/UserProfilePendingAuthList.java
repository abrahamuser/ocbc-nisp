...
public class UserProfilePendingAuthList extends MiBServices
{

	public UserProfilePendingAuthList(WebServiceContext session)
	{
		super(session);
	...
	private static Logger log = LogManager.getLogger(UserProfilePendingAuthList.class);
	ObProfileMaintRequest obRequest;

	@Override
	public ObRequest getBDObject()
	{
		func_id = MiBConstant.FUNC_MCB_USRPRF_AUTH_LIST;//MiBConstant.FUNC_MCB_TIMEDPS_ACCTDETAILS;
		return obRequest;
	}
