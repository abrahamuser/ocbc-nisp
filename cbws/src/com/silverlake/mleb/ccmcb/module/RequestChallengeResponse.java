...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TOKEN_CR_REQUEST)
public class RequestChallengeResponse extends SessionMiBServices<ObAuthenticationRequest, ObAuthenticationResponse>{
	@WSParameter(isMandatory=true)
	protected String requestType;
	
	public RequestChallengeResponse(WebServiceContext wsContext) {
		super(wsContext);
	}

	@Override
	public void processData() throws Exception{
		obRequest.setIdType(requestType);
	}
