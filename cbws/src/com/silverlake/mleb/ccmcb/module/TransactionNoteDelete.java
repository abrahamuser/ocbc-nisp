...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TRANS_NOTES_DELETE)
public class TransactionNoteDelete extends SessionMiBServices<ObTransactionSummaryRequest, ObTransactionSummaryResponse>{
	...
	public TransactionNoteDelete(WebServiceContext wsContext) {
		super(wsContext);
	}
	...
	public void processData() throws Exception{
		...
		obRequest.setPymtMasterId(noteId);
	}
