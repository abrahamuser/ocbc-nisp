...
public class SoftwareTokenPreBind2Request extends MiBServices
{
	public SoftwareTokenPreBind2Request(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_SOFT_TOKEN_PREBIND2;
		return obRequest;
	}

	public void processData(String device_code, String device_finger_print)
	{
		// set request to bd
		...
		obRequest.setDevice_code(device_code);
	...
	public void processResponse()
	{
		...
		{
			httpSession.setAttribute(WSConstant.MIB_SOFT_TOKEN_PREBIND2, obResponse);
		}
	}
