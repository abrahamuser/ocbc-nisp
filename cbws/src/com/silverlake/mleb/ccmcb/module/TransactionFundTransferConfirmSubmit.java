...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TRANS_FUND_CNFRM_TRANS_SUBMIT)
@WSCache(
...
public class TransactionFundTransferConfirmSubmit extends CacheSessionMiBServices<ObTransactionRequest, ObTransactionResponse, ObSessionCache>{
	...
	public TransactionFundTransferConfirmSubmit(WebServiceContext wsContext) {
		super(wsContext);
	}
