...
public class UpdateEnrolSwToken extends MiBServices
{
	public UpdateEnrolSwToken(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_ENRL_DEF_TK;
		return obRequest;
	}
	...
	public void processResponse()
	{
		...
		{
			httpSession.setAttribute(WSConstant.MIB_SOFT_ENRL_DEF_TK, obResponse);
		}
	}
