...
public class OTPRequest extends MiBServices
{
	public OTPRequest(WebServiceContext session) {
		super(session);
	...
	public ObRequest getBDObject() {
		func_id = MiBConstant.FUNC_MCB_OTP_REQ;
		return obRequest;
	}
	...
	public void processData(String request_type)
	{
		...
		obRequest.setResendTagCount(otpResponse==null?0:otpResponse.getResendTagCount()); 
		obRequest.setResendTagLastDate(otpResponse==null?null:otpResponse.getResendTagDateTime());
	}
	...
	public void processResponse() {
		...
		if(obResponse.getObHeader().getStatusCode().equalsIgnoreCase(MiBConstant.MIB_COMMON_SUCCESS))
		{
			...
			httpSession.setAttribute(WSConstant.MIB_OTP_REQ, obResponse);
		}
	}
