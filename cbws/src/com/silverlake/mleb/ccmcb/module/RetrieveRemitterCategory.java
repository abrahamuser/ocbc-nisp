...
@WSClass(functionId= VCMethodConstant.FUNCTION_CODES.FUNC_MCB_REMITTER_CATEGORY)

public class RetrieveRemitterCategory extends SessionMiBServices<ObTransactionRequest, ObTransactionResponse> {
    ...
    public RetrieveRemitterCategory(WebServiceContext wsContext) {
        super(wsContext);
    }
