...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_PYMT_CNFM_SUBMIT)
@WSCache(
...
public class PaymentConfirmSubmit extends CacheSessionMiBServices<ObPaymentRequest, ObPaymentResponse, ObPaymentSessionCache>{
	...
	public PaymentConfirmSubmit(WebServiceContext wsContext) {
		super(wsContext);
	}
