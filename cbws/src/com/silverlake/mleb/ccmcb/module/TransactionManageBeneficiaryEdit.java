...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TRANS_MGMT_BENE_EDIT)
@WSCache(
...
public class TransactionManageBeneficiaryEdit extends CacheSessionMiBServices<ObTransactionManageBeneficiaryRequest, ObTransactionManageBeneficiaryResponse, ObTransactionManageBeneficiarySessionCache>{
	...
	public TransactionManageBeneficiaryEdit(WebServiceContext wsContext) {
		super(wsContext);
	}
