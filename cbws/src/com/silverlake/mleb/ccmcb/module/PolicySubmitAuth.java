...
public class PolicySubmitAuth extends MiBServices
{

	public PolicySubmitAuth(WebServiceContext session)
	{
		super(session);
	...
	private static Logger log = LogManager.getLogger(PolicySubmitAuth.class);
	ObProfileMaintRequest obRequest;

	@Override
	public ObRequest getBDObject()
	{
		func_id = MiBConstant.FUNC_MCB_POLICY_AUTH_SUBMIT;//MiBConstant.FUNC_MCB_TIMEDPS_ACCTDETAILS;
		return obRequest;
	}
	...
	public void processData(String action,String recordIdList)
	{
		...
		if(null!=objSession)
		{
			obRequest.setPolicy_list(objSession.getPolicy_list());
		}
