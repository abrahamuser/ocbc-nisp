...
public class RetrieveBoardNotificationInbox extends MiBServices
{

	public RetrieveBoardNotificationInbox(WebServiceContext session)
	{
		super(session);
	...
	{
		func_id = MiBConstant.FUNC_MCB_BOARD_NOTIFICATION_INBOX;
		return obRequest;
	}

	public void processData(String notify_type,String page_no, String pageSize)
	{
		// set request to bd
		...
		obRequest.setNotify_type(notify_type);
