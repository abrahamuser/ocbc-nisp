...
@WSClass(functionId=VCMethodConstant.FUNCTION_CODES.FUNC_MCB_TRANS_NOTES_LIST)
public class RetrieveTransactionNotes extends SessionMiBServices<ObTransactionSummaryRequest, ObTransactionSummaryResponse>{
	...
	public RetrieveTransactionNotes(WebServiceContext wsContext) {
		super(wsContext);
	}
