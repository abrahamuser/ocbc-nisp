...
public class AccessProfileSubmitAuth extends MiBServices
{

	public AccessProfileSubmitAuth(WebServiceContext session)
	{
		super(session);
	...
	private static Logger log = LogManager.getLogger(AccessProfileSubmitAuth.class);
	ObProfileMaintRequest obRequest;

	@Override
	public ObRequest getBDObject()
	{
		func_id = MiBConstant.FUNC_MCB_ACCESS_AUTH_SUBMIT;//MiBConstant.FUNC_MCB_TIMEDPS_ACCTDETAILS;
		return obRequest;
	}
	...
	public void processData(String action,String recordIdList)
	{
		...
		if(null!=objSession)
		{
			obRequest.setAccess_list(objSession.getAccprofile_list());
		}
