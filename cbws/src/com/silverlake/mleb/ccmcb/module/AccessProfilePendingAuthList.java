...
public class AccessProfilePendingAuthList extends MiBServices
{

	public AccessProfilePendingAuthList(WebServiceContext session)
	{
		super(session);
	...
	private static Logger log = LogManager.getLogger(AccessProfilePendingAuthList.class);
	ObProfileMaintRequest obRequest;

	@Override
	public ObRequest getBDObject()
	{
		func_id = MiBConstant.FUNC_MCB_ACCESS_AUTH_LIST;//MiBConstant.FUNC_MCB_TIMEDPS_ACCTDETAILS;
		return obRequest;
	}
