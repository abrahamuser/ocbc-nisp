...
public class AppleNotificationServerBasicImpl extends AppleServerBasicImpl implements AppleNotificationServer {
	 ...
	 */
	public AppleNotificationServerBasicImpl(Object keystore, String password, boolean production, String serverIp) throws KeystoreException {
		this(keystore, password, ConnectionToAppleServer.getKeystoreType(), production, serverIp);
	}
	 ...
	 * @throws KeystoreException thrown if an error occurs when loading the keystore
	 */
	public AppleNotificationServerBasicImpl(Object keystore, String password, String type, boolean production, String serverIp) throws KeystoreException {
		//this(keystore, password, type, production ? PRODUCTION_HOST : DEVELOPMENT_HOST, production ? PRODUCTION_PORT : DEVELOPMENT_PORT);
		this(keystore, password, type, serverIp==null ? PRODUCTION_HOST : serverIp, production ? PRODUCTION_PORT : DEVELOPMENT_PORT);
	}
