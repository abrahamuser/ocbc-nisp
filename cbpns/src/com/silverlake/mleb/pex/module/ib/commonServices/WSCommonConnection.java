...
import com.fuzion.ws.common.endpoint.CommonEndpointService;
import com.fuzion.ws.common.endpoint.CommonService;
 ...
 * 
 */
public class WSCommonConnection {

	private static final QName SERVICE_NAME = new QName("http://endpoint.common.ws.fuzion.com/", "CommonEndpointService");
	private PropertiesManager pmgr = new PropertiesManager();
    public WSCommonConnection() {
    }
    
    private URL wsdlURL = CommonEndpointService.WSDL_LOCATION;
    public CommonService getServicePort() throws Exception
    {
    	CommonEndpointService ss = null;
    	CommonService port = null;
    	URL constantURL  = null;
    	
    	
    	constantURL = new URL(pmgr.getProperty("fuzion.ws.url")+"/CommonService"+"?wsdl");
    	
		
		ss = new CommonEndpointService(constantURL, SERVICE_NAME);
		
		port = ss.getCommonServicePort();
