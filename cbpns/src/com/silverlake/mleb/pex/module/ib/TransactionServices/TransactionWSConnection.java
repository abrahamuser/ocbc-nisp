...
import com.fuzion.ws.transaction.endpoint.TransactionEndpointService;
import com.fuzion.ws.transaction.endpoint.TransactionService;
 ...
 * 
 */
public class TransactionWSConnection {

	private static final QName SERVICE_NAME = new QName("http://endpoint.transaction.ws.fuzion.com/", "TransactionEndpointService");
	private PropertiesManager pmgr = new PropertiesManager();
    public TransactionWSConnection() {
    }
    
    private URL wsdlURL = TransactionEndpointService.WSDL_LOCATION;
    public TransactionService getServicePort() throws Exception
    {
    	TransactionEndpointService ts = null;
    	TransactionService port = null;
    	URL constantURL  = null;
    	
    	
    	constantURL = new URL(pmgr.getProperty("fuzion.ws.url")+"/TransactionService"+"?wsdl");
    	
		
		ts = new TransactionEndpointService(constantURL, SERVICE_NAME);
		
		port = ts.getTransactionServicePort();            
