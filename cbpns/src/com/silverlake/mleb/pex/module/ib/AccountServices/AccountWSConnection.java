...
import com.fuzion.ws.account.endpoint.AccountEndpointService;
import com.fuzion.ws.account.endpoint.AccountService;
 ...
 * 
 */
public class AccountWSConnection {

	private static final QName ACCOUNT_NAME = new QName("http://endpoint.account.ws.fuzion.com/", "AccountEndpointService");
	private PropertiesManager pmgr = new PropertiesManager();
    public AccountWSConnection() {
    }
    
    private URL wsdlURL = AccountEndpointService.WSDL_LOCATION;
    public AccountService getAccountPort() throws Exception
    {
    	AccountEndpointService as = null;
    	AccountService port = null;
    	URL constantURL  = null;
    	
    	
    	constantURL = new URL(pmgr.getProperty("fuzion.ws.url")+"/AccountService"+"?wsdl");
    	
		
		as = new AccountEndpointService(constantURL, ACCOUNT_NAME);
		
		port = as.getAccountServicePort();            
