...
import com.silverlake.hlb.mib.entity.HlbIbwsTranx;
...
public abstract class IBWSService 
{
	...
	{
		//update db
		HlbIbwsTranx logTranx = new HlbIbwsTranx();
	...
	{
		String[] masks = {"pin","password","mPassword"};
	...
	public HlbIbwsTranx getIbwsLog() {
		return ibwsLog;
	}


	public void setIbwsLog(HlbIbwsTranx ibwsLog) {
		this.ibwsLog = ibwsLog;
	}
